...
void COpp::Get_Itemtype(OBJID _Item)
{
	switch (_Item)
	{
	case OBJ_ITEM_HEAL:
...
void COpp::Release(void)
{
	//CBmpMgr::Destroy_Instance();
}


void COpp::Key_Input(void)
{
